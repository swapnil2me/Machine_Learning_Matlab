...
void plotData_api(const mxArray * const prhs[2], int32_T nlhs)
{
  emxArray_real_T *x;
  emxArray_real_T *y;
...
void plotData_atexit(void)
{
  ...
  plotData_xil_terminate();
  plotData_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void plotData_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_plotData_api.c) */
